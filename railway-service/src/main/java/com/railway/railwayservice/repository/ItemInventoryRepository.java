...
public interface ItemInventoryRepository  extends JpaRepository<InventoryEntity, Long> {
    ...
    List<InventoryResponseDto> findAllByInventory(@Param("goodsId") Long goodsId, @Param("isDeleted") boolean isDeleted, @Param("inventoryType") List<String> inventoryType);
}
